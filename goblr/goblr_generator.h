...
class Generator
{
  public:
    ...
    static MatrixGroup::Ptr liberties(const goblb::Board& board);

    static MatrixGroup::Ptr representation(const goblb::Board& board);
...
// INLINES
inline
MatrixGroup::Ptr Generator::representation(const goblb::Board& board)
{
    MatrixGroup::Ptr matrixGroup_p = liberties(board);
